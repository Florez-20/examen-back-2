...
public class DetalleCine {
   ...
   @GeneratedValue(strategy = GenerationType.IDENTITY)
    ...
    @Column(name = "direccion",length = 50, nullable = false,unique = true)
    private String direccion;

    @Column(name = "ciudad",length = 50, nullable = false,unique = false)
    ...
    @OneToOne
    @JoinColumn(name = "FK_cines",referencedColumnName = "id")
